...
import LeaderboardControllerHome from '../controllers/LeaderboardHome.controller';
...
const leaderboardControllerHome = new LeaderboardControllerHome(leaderboardServiceHome);
...
app.get('/leaderboard/home', (req, res) => leaderboardControllerHome.createBoard(req, res));
app.get('/leaderboard/away', (req, res) => leaderboardControllerAway.createBoard(req, res));
